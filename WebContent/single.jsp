...
<%    
		...
		String p_date = null;
			...
			try {
				...
				ResultSet resultset = statement.executeQuery("SELECT * FROM `e-commerce`.product where product_id = '"+ p_id +"'");	
  ...
  <div >
      <img src="getImage.jsp?id=<%=p_id%>" style="max-height:300px; max-width: 300px;" alt="">
					...
					<div class="col-md-7 single-top-in simpleCart_shelfItem">
						...
						<h4><%=p_title%></h4>
							...
							<h5 class="item_price">$ <%=p_price%></h5>
							<p> <%=p_description %></p>
							
							<p>上架時間：<%=p_date%></p>
							<p>剩餘數量：<%=p_quantity%></p>
							<a href="cart?id=<%=p_id %>&action=add" class="add-cart item_add" >加到購物車中</a>
						</div>
					</div>
					<%
			}}	catch(Exception e){
